...
//			}
	...
	public static void main(String args[]) throws FileNotFoundException, IOException {
		...
		Dispatch.carNum = 3;
		int initCarNum = 10;
		areas.add(dispatch.new Area(0, "远洋未来汇购物中心", 28,23));
		areas.add(dispatch.new Area(1, "北京市朝阳区西柳巷98号", -106,-101));
		areas.add(dispatch.new Area(2, "国粹苑C座", -63,-55));
		areas.add(dispatch.new Area(3, "呼家楼地铁站", 39,31));
		areas.add(dispatch.new Area(4, "八里庄路（汉庭酒店）", -29,-21));
		areas.add(dispatch.new Area(5, "朝阳区定福庄第一小学", -72,-64));
		areas.add(dispatch.new Area(6, "红领巾公园", -81,-73));
		areas.add(dispatch.new Area(7, "芳菁院小区", 43,35));
		areas.add(dispatch.new Area(8, "高碑店新村小区", 50,44));
		areas.add(dispatch.new Area(9, "平房区小街巷", 49,44));
		areas.add(dispatch.new Area(10, "人民日报社", -31,-22));
		areas.add(dispatch.new Area(11, "首都经济贸易大学", 30,23));
		dispatch.initNeed();
